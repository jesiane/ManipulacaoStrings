/*Faça um programa que encontre o conjunto de 5 dígitos consecutivos 
 * na sequência abaixo que gere o maior produto:*/
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < Numeros.Length - 4; i++)
            {
                ...
                for (int j = 0; j < 5; j++)
                {
                    int digito = int.Parse(Numeros.Substring(i, j + 1));
                    produtoAtual *= digito;
                }
            ...
            Console.WriteLine($"Maior produtos: {maiorProduto}");
